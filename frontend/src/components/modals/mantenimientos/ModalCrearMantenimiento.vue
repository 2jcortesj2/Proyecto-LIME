  ...
  <div class="modal" :class="{ active: show }">
    <div class="modal-content" style="max-width: 600px;">
      <div class="modal-header">
        <h3 class="modal-title"><AppIcon name="plus" size="16" /> Registrar Nuevo Mantenimiento</h3>
        ...
        <form @submit.prevent="$emit('submit')">
          ...
          <div class="form-grid">
            <div class="form-group">
              ...
              <select v-model="localForm.tipo_mantenimiento" class="form-select">
            ...
            <div class="form-group">
              ...
              <input type="date" v-model="localForm.fecha_mantenimiento" class="form-input">
            </div>
          </div>
          ...
          <div class="form-grid">
            <div class="form-group">
              ...
              <input type="text" v-model="localForm.realizado_por" class="form-input" placeholder="Técnico o Empresa">
            </div>
            <div class="form-group">
              <label class="form-label">Costo</label>
              <input type="number" v-model="localForm.costo" class="form-input" placeholder="0.00">
            </div>
          </div>

          <div class="form-group full-width" style="margin-top: 15px;">
            <label class="form-label required">Descripción</label>
            <textarea v-model="localForm.descripcion" class="form-textarea" rows="3" placeholder="Descripción del trabajo realizado..."></textarea>
          </div>

          <div class="form-group full-width">
            <label class="form-label">Observaciones</label>
            <textarea v-model="localForm.observaciones" class="form-textarea" rows="2" placeholder="Observaciones adicionales..."></textarea>
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button class="btn btn-secondary" @click="$emit('close')">Cancelar</button>
        <button class="btn btn-primary" @click="$emit('submit')">Registrar Mantenimiento</button>
      </div>
    </div>
  </div>
</template>
...
<style scoped>
/* Estilos copiados de Traslados.vue para consistencia */
