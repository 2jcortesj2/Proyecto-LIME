          ...
          <div v-show="form.activeTab === 1" class="tab-content">
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.nombre_equipo" class="form-input" :class="{ 'input-error': form.formErrors.nombre_equipo }" placeholder="Ej: Ventilador Mecánico">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.codigo_interno" class="form-input" :class="{ 'input-error': form.formErrors.codigo_interno }" placeholder="Ej: LIME-001">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.codigo_ips" class="form-input" placeholder="Código IPS">
              </div>

              <div class="form-group">
                <label class="form-label">Código ECRI</label>
                <input type="text" v-model="form.form.codigo_ecri" class="form-input" placeholder="Código ECRI">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.ubicacion_fisica" class="form-input" :class="{ 'input-error': form.formErrors.ubicacion_fisica }" placeholder="Ej: Piso 2, Sala 201">
          ...
          <div v-show="form.activeTab === 2" class="tab-content">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.marca" class="form-input" :class="{ 'input-error': form.formErrors.marca }" placeholder="Ej: Philips">
                <span v-if="form.formErrors.marca" class="error-text">{{ form.formErrors.marca }}</span>
              </div>

              <div class="form-group">
                <label class="form-label required">Modelo</label>
                <input type="text" v-model="form.form.modelo" class="form-input" :class="{ 'input-error': form.formErrors.modelo }" placeholder="Ej: V60">
                <span v-if="form.formErrors.modelo" class="error-text">{{ form.formErrors.modelo }}</span>
              </div>

              <div class="form-group">
                <label class="form-label required">Serie</label>
                <input type="text" v-model="form.form.serie" class="form-input" :class="{ 'input-error': form.formErrors.serie }" placeholder="Ej: SN123456">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.registro_invima" class="form-input" placeholder="Registro INVIMA">
              </div>
          ...
          <div v-show="form.activeTab === 3" class="tab-content">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="number" v-model="form.form.tiempo_vida_util" class="form-input" placeholder="10">
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.propietario" class="form-input" :class="{ 'input-error': form.formErrors.propietario }" placeholder="Universidad de Antioquia">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.nit_proveedor" class="form-input" :class="{ 'input-error': form.formErrors.nit_proveedor }" placeholder="900123456-7">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.nombre_proveedor" class="form-input" :class="{ 'input-error': form.formErrors.nombre_proveedor }" placeholder="Nombre del proveedor">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.tipo_documento" class="form-input" :class="{ 'input-error': form.formErrors.tipo_documento }" placeholder="Factura">
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.numero_documento" class="form-input" :class="{ 'input-error': form.formErrors.numero_documento }" placeholder="FAC-2024-001">
              ...
              <div class="form-group">
                ...
                <input type="number" v-model="form.form.valor_compra" class="form-input" placeholder="50000000">
              </div>
            </div>
          </div>
          ...
          <div v-show="form.activeTab === 5" class="tab-content">
            ...
            <div class="form-grid">
              ...
              <div class="form-group" v-if="form.form.requiere_mantenimiento">
                ...
                <input type="text" v-model="form.form.frecuencia_mantenimiento" class="form-input" placeholder="Semestral">
              </div>
              ...
              <div class="form-group" v-if="form.form.requiere_calibracion">
                ...
                <input type="text" v-model="form.form.magnitud" class="form-input" placeholder="Temperatura">
              </div>

              <div class="form-group" v-if="form.form.requiere_calibracion">
                <label class="form-label">Rango del Equipo</label>
                <input type="text" v-model="form.form.rango_equipo" class="form-input" placeholder="0-100°C">
              </div>

              <div class="form-group" v-if="form.form.requiere_calibracion">
                <label class="form-label">Rango de Trabajo</label>
                <input type="text" v-model="form.form.rango_trabajo" class="form-input" placeholder="20-80°C">
              </div>

              <div class="form-group" v-if="form.form.requiere_calibracion">
                <label class="form-label">Resolución</label>
                <input type="text" v-model="form.form.resolucion" class="form-input" placeholder="0.1°C">
              </div>

              <div class="form-group" v-if="form.form.requiere_calibracion">
                <label class="form-label">Error Máximo</label>
                <input type="text" v-model="form.form.error_maximo" class="form-input" placeholder="±0.5°C">
              </div>
            </div>
          </div>
          ...
          <div v-show="form.activeTab === 6" class="tab-content">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="text" v-model="form.form.voltaje" class="form-input" placeholder="110V">
              </div>

              <div class="form-group">
                <label class="form-label">Corriente</label>
                <input type="text" v-model="form.form.corriente" class="form-input" placeholder="5A">
              </div>

              <div class="form-group">
                <label class="form-label">Potencia</label>
                <input type="text" v-model="form.form.potencia" class="form-input" placeholder="550W">
              </div>

              <div class="form-group">
                <label class="form-label">Presión</label>
                <input type="text" v-model="form.form.presion" class="form-input" placeholder="50-60 PSI">
              </div>

              <div class="form-group">
                <label class="form-label">Dimensiones</label>
                <input type="text" v-model="form.form.dimensiones" class="form-input" placeholder="50x40x30 cm">
              </div>

              <div class="form-group">
                <label class="form-label">Peso</label>
                <input type="text" v-model="form.form.peso" class="form-input" placeholder="15kg">
              </div>

              <div class="form-group" style="grid-column: span 2;">
                <label class="form-label">Otros</label>
                <textarea v-model="form.form.otros" class="form-input" rows="3" placeholder="Otra información relevante..."></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="modal-footer">
            ...
            <div class="form-actions">
              ...
              <button type="submit" class="btn-primary" :disabled="form.submitLoading">
                {{ form.submitLoading ? 'Guardando...' : 'Guardar Equipo' }}
              </button>
            </div>
          </div>
        </form>
...
const form = useEquipoForm('create')
